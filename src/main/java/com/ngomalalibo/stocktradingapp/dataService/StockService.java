...
@Slf4j
@Service
public class StockService implements IEXCloudV1RestRequest
{
    ...
    protected static void setCompanyURL(String company)
    {
        ...
        try
        {
            ...
            if (conn.getResponseCode() == 200)
            {
                ...
                if ((output = in.readLine()) != null)
                {
                    ...
                    return objectMapper.readValue(output, Stock.class);
